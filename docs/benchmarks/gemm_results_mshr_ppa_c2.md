...
Generated 2026-08-14 22:33. **Re-runnable**: `python3 scripts/gen_sweep_doc_c2.py` refreshes this file as arms complete.
...
These arms build from `7737baee`, which adds **B1b, C3 and C2** over the opt3 sweep's base.
...
|---|---:|---:|---:|---:|---:|---:|---:|:---|---:|---:|---:|---:|---:|---:|---:|
| 128x1024x512 | 65,536 | 10 | 5 | 16 | 1 | 16 | 0 | `1149dab0` | 67,693 | 96.8% | — | _25p_ | — | — | **—** |
| 256x1024x256 | 65,536 | 10 | 5 | 8 | 2 | 8 | 2047 | `046f329e` | 68,253 | 96.0% | — | _38p_ | — | — | **—** |
| 128x512x512 | 32,768 | 9 | 5 | 16 | 1 | 16 | 0 | `edd55ba5` | 34,489 | 95.0% | — | _23p_ | — | — | **—** |
| 256x512x256 | 32,768 | 9 | 5 | 8 | 2 | 8 | 2047 | `09e2cdf8` | 34,821 | 94.1% | 34,703 | 34,547 | 94.9% | -0.8% | **-0.45%** |
| 256x512x512 | 65,536 | 9 | 6 | 8 | 2 | 8 | 2047 | `1f7a3ed8` | 71,218 | 92.0% | — | _36p_ | — | — | **—** |
...
| 512x512x512 | 131,072 | 9 | 7 | 4 | 4 | 4 | 2047 | `97c85346` | 153,707 | 85.3% | — | _38p_ | — | — | **—** |
| 512x256x512 | 65,536 | 8 | 7 | 4 | 4 | 4 | 2047 | `2903acbf` | 78,314 | 83.7% | — | _37p_ | — | — | **—** |
...
| 512x128x512 | 32,768 | 7 | 7 | 4 | 4 | 4 | 2047 | `6045d69e` | 42,767 | 76.6% | 42,554 | _41p_ | — | — | **—** |
...
**16 of 23 complete**, 16 with an opt3 counterpart to pair against.

- **C2 alone (vs opt3): mean -6.62%** · best -89.74% · worst +5.21%
- whole tree (vs `gemm_results.md`): mean +4.4% · best -7.6% · worst +73.6%
