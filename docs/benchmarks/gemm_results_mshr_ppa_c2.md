...
`1024x128x128` and +803% on `128x1024x512`, so that term can be large.

**The `Δ vs opt3` column — the C2 measurement itself — is unaffected.** All three sweeps set
`serve_timeout=2047` identically on these shapes, so C2-alone stays a clean single-knob
comparison. Only `Δ vs old` is confounded, and only on these four rows.

## Confound, stated up front

These arms build from `668922e3`, which adds **B1b, C3 and C2** over the opt3 sweep's base.
...
|---|---:|---:|---:|---:|---:|---:|---:|:---|---:|---:|---:|---:|---:|---:|---:|
| 128x1024x512 | 65,536 | 10 | 5 | 16 | 1 | 16 | 0 | `1149dab0` | 67,693 | 96.8% | 139,129 | 130,792 | 50.1% | +93.2% | **-5.99%** |
| 256x1024x256 | 65,536 | 10 | 5 | 8 | 2 | 8 | 2047 | `046f329e` | 68,253 | 96.0% | 68,607 | 68,410 | 95.8% | +0.2% | **-0.29%** |
| 128x512x512 | 32,768 | 9 | 5 | 16 | 1 | 16 | 0 | `edd55ba5` | 34,489 | 95.0% | 46,256 | 41,943 | 78.1% | +21.6% | **-9.32%** |
| 256x512x256 | 32,768 | 9 | 5 | 8 | 2 | 8 | 2047 | `09e2cdf8` | 34,821 | 94.1% | 34,703 | 34,547 | 94.9% | -0.8% | **-0.45%** |
| 256x512x512 | 65,536 | 9 | 6 | 8 | 2 | 8 | 2047 | `1f7a3ed8` | 71,218 | 92.0% | 70,550 | 71,116 | 92.2% | -0.1% | **+0.80%** |
| 128x256x512 | 16,384 | 8 | 5 | 16 | 1 | 16 | 0 | `a0dd1086` | 18,082 | 90.6% | 25,498 | 21,614 | 75.8% | +19.5% | **-15.23%** |
| 256x256x256 | 16,384 | 8 | 5 | 8 | 2 | 8 | 2047 | `eff18904` | 18,177 | 90.1% | 18,210 | 17,984 | 91.1% | -1.1% | **-1.24%** |
| 512x256x256 | 32,768 | 8 | 6 | 4 | 4 | 4 | 2047 | `4bfabeee` | 37,632 | 87.1% | 38,397 | 38,260 | 85.6% | +1.7% | **-0.36%** |
| 512x512x128 | 32,768 | 9 | 5 | 4 | 4 | 4 | 2047 | `aec98132` | 38,325 | 85.5% | 36,959 | 38,885 | 84.3% | +1.5% | **+5.21%** |
| 512x512x512 | 131,072 | 9 | 7 | 4 | 4 | 4 | 2047 | `97c85346` | 153,707 | 85.3% | 156,294 | 154,734 | 84.7% | +0.7% | **-1.00%** |
| 512x256x512 | 65,536 | 8 | 7 | 4 | 4 | 4 | 2047 | `2903acbf` | 78,314 | 83.7% | 80,468 | 79,653 | 82.3% | +1.7% | **-1.01%** |
| 128x128x512 | 8,192 | 7 | 5 | 16 | 1 | 16 | 0 | `f4e7253a` | 9,792 | 83.7% | 165,585 | 16,995 | 48.2% | +73.6% | **-89.74%** |
| 256x128x256 | 8,192 | 7 | 5 | 8 | 2 | 8 | 2047 | `55b75bcd` | 10,014 | 81.8% | 9,831 | 9,944 | 82.4% | -0.7% | **+1.15%** |
| 512x256x128 | 16,384 | 8 | 5 | 4 | 4 | 4 | 2047 | `30c8a832` | 20,155 | 81.3% | 19,819 | 19,493 | 84.1% | -3.3% | **-1.64%** |
| 512x128x256 | 16,384 | 7 | 6 | 4 | 4 | 4 | 2047 | `15e8ddef` | 20,307 | 80.7% | 20,575 | 20,538 | 79.8% | +1.1% | **-0.18%** |
| 512x128x512 | 32,768 | 7 | 7 | 4 | 4 | 4 | 2047 | `6045d69e` | 42,767 | 76.6% | 42,554 | 42,743 | 76.7% | -0.1% | **+0.44%** |
| 512x128x128 | 8,192 | 7 | 5 | 4 | 4 | 4 | 2047 | `bb2834ad` | 11,111 | 73.7% | 11,493 | 11,144 | 73.5% | +0.3% | **-3.04%** |
| 256x64x256 | 4,096 | 6 | 5 | 8 | 2 | 8 | 2047 | `52e63dfe` | 6,050 | 67.7% | 5,804 | 5,860 | 69.9% | -3.1% | **+0.96%** |
| 512x64x256 | 8,192 | 6 | 6 | 4 | 4 | 4 | 2047 | `fa6007d0` | 12,183 | 67.2% | 11,898 | 11,930 | 68.7% | -2.1% | **+0.27%** |
| 512x64x512 | 16,384 | 6 | 7 | 4 | 4 | 4 | 2047 | `fe1ebb97` | 24,616 | 66.6% | 24,300 | 24,607 | 66.6% | -0.0% | **+1.26%** |
| 256x32x512 | 4,096 | 5 | 6 | 8 | 2 | 8 | 2047 | `afc79e88` | 6,752 | 60.7% | 6,584 | 6,598 | 62.1% | -2.3% | **+0.21%** |
| 512x32x512 | 8,192 | 5 | 7 | 4 | 4 | 4 | 2047 | `9209f128` | 16,238 | 50.4% | 15,213 | 15,088 | 54.3% | -7.1% | **-0.82%** |
| 256x32x256 | 2,048 | 5 | 5 | 8 | 2 | 8 | 2047 | `697a398d` | 4,081 | 50.2% | 3,859 | 3,771 | 54.3% | -7.6% | **-2.28%** |

**23 of 23 complete**, 23 with an opt3 counterpart to pair against.

- **C2 alone (vs opt3): mean -5.32%** · best -89.74% · worst +5.21%
- whole tree (vs `gemm_results.md`): mean +8.1% · best -7.6% · worst +93.2%
