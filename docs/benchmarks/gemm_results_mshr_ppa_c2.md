...
Generated 2026-08-14 18:20. **Re-runnable**: `python3 scripts/gen_sweep_doc_c2.py` refreshes this file as arms complete.
...
These arms build from `f7a7e90f`, which adds **B1b, C3 and C2** over the opt3 sweep's base.
...
|---|---:|---:|---:|---:|---:|---:|---:|:---|---:|---:|---:|---:|---:|---:|---:|
| 128x1024x512 | 65,536 | 10 | 5 | 16 | 1 | 16 | 0 | `1149dab0` | 67,693 | 96.8% | — | _2p_ | — | — | **—** |
| 256x1024x256 | 65,536 | 10 | 5 | 8 | 2 | 8 | 2047 | `046f329e` | 68,253 | 96.0% | — | _3p_ | — | — | **—** |
| 128x512x512 | 32,768 | 9 | 5 | 16 | 1 | 16 | 0 | `edd55ba5` | 34,489 | 95.0% | — | _2p_ | — | — | **—** |
| 256x512x256 | 32,768 | 9 | 5 | 8 | 2 | 8 | 2047 | `09e2cdf8` | 34,821 | 94.1% | — | _3p_ | — | — | **—** |
| 256x512x512 | 65,536 | 9 | 6 | 8 | 2 | 8 | 2047 | `1f7a3ed8` | 71,218 | 92.0% | — | _2p_ | — | — | **—** |
| 128x256x512 | 16,384 | 8 | 5 | 16 | 1 | 16 | 0 | `a0dd1086` | 18,082 | 90.6% | — | _2p_ | — | — | **—** |
| 256x256x256 | 16,384 | 8 | 5 | 8 | 2 | 8 | 2047 | `eff18904` | 18,177 | 90.1% | — | _3p_ | — | — | **—** |
| 512x256x256 | 32,768 | 8 | 6 | 4 | 4 | 4 | 2047 | `4bfabeee` | 37,632 | 87.1% | — | _3p_ | — | — | **—** |
| 512x512x128 | 32,768 | 9 | 5 | 4 | 4 | 4 | 2047 | `aec98132` | 38,325 | 85.5% | — | _4p_ | — | — | **—** |
| 512x512x512 | 131,072 | 9 | 7 | 4 | 4 | 4 | 2047 | `97c85346` | 153,707 | 85.3% | — | _1p_ | — | — | **—** |
| 512x256x512 | 65,536 | 8 | 7 | 4 | 4 | 4 | 2047 | `2903acbf` | 78,314 | 83.7% | — | _1p_ | — | — | **—** |
| 128x128x512 | 8,192 | 7 | 5 | 16 | 1 | 16 | 0 | `f4e7253a` | 9,792 | 83.7% | — | _3p_ | — | — | **—** |
| 256x128x256 | 8,192 | 7 | 5 | 8 | 2 | 8 | 2047 | `55b75bcd` | 10,014 | 81.8% | 9,831 | _4p_ | — | — | **—** |
| 512x256x128 | 16,384 | 8 | 5 | 4 | 4 | 4 | 2047 | `30c8a832` | 20,155 | 81.3% | — | _4p_ | — | — | **—** |
| 512x128x256 | 16,384 | 7 | 6 | 4 | 4 | 4 | 2047 | `15e8ddef` | 20,307 | 80.7% | — | _3p_ | — | — | **—** |
| 512x128x512 | 32,768 | 7 | 7 | 4 | 4 | 4 | 2047 | `6045d69e` | 42,767 | 76.6% | — | _1p_ | — | — | **—** |
| 512x128x128 | 8,192 | 7 | 5 | 4 | 4 | 4 | 2047 | `bb2834ad` | 11,111 | 73.7% | 11,493 | _5p_ | — | — | **—** |
| 256x64x256 | 4,096 | 6 | 5 | 8 | 2 | 8 | 2047 | `52e63dfe` | 6,050 | 67.7% | 5,804 | _4p_ | — | — | **—** |
| 512x64x256 | 8,192 | 6 | 6 | 4 | 4 | 4 | 2047 | `fa6007d0` | 12,183 | 67.2% | 11,898 | _3p_ | — | — | **—** |
| 512x64x512 | 16,384 | 6 | 7 | 4 | 4 | 4 | 2047 | `fe1ebb97` | 24,616 | 66.6% | — | _0p_ | — | — | **—** |
| 256x32x512 | 4,096 | 5 | 6 | 8 | 2 | 8 | 2047 | `afc79e88` | 6,752 | 60.7% | 6,584 | _3p_ | — | — | **—** |
| 512x32x512 | 8,192 | 5 | 7 | 4 | 4 | 4 | 2047 | `9209f128` | 16,238 | 50.4% | — | _1p_ | — | — | **—** |
| 256x32x256 | 2,048 | 5 | 5 | 8 | 2 | 8 | 2047 | `697a398d` | 4,081 | 50.2% | 3,859 | 3,771 | 54.3% | -7.6% | **-2.28%** |

**1 of 23 complete**, 1 with an opt3 counterpart to pair against.

- **C2 alone (vs opt3): mean -2.28%** · best -2.28% · worst -2.28%
- whole tree (vs `gemm_results.md`): mean -7.6% · best -7.6% · worst -7.6%
