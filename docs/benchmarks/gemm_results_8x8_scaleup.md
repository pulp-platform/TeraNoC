...
Generated 2026-08-25 00:06 by `scripts/gen_8x8_scaleup_doc.py`. **Re-run rather than editing.**
...
Efficiency over the 130 measurements: **median 37.8%**, mean 38.3%, range 7.4–86.6%.
