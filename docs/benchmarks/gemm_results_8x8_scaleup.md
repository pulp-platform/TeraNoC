...
Generated 2026-08-26 06:59 by `scripts/gen_8x8_scaleup_doc.py`. **Re-run rather than editing.**
...
Efficiency over the 153 measurements: **median 39.1%**, mean 40.6%, range 7.4–86.6%.
...
| **4** | 36.7% (8) | 48.9% (8) | 59.4% (7) | 53.6% (4) | 62.0% (2) |
