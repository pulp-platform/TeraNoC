...
Generated 2026-08-27 18:59 by `scripts/gen_8x8_scaleup_doc.py`. **Re-run rather than editing.**
...
Efficiency over the 178 measurements: **median 41.9%**, mean 43.5%, range 7.4–89.3%.
