...
Generated 2026-08-16 23:33. **Re-runnable**: `python3 scripts/gen_shape_status.py`.
...
| M×N×P | ideal | baseline | opt2 | opt3 | C2 | E1 | CSR | BYP | CSRBYP | **current** | from | **eff** | **Δ vs base** | best | from |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|:--|---:|---:|---:|:--|
| 256x1024x256 | 65,536 | 68,253 | 68,689 | 68,607 | 68,410 | 68,410 | 68,379 | — | — | **68,410** | E1 | **95.8%** | **+0.2%** | 68,379 | CSR |
| 256x512x256 | 32,768 | 34,821 | 34,671 | 34,703 | 34,547 | 34,547 | 34,812 | — | — | **34,547** | E1 | **94.9%** | **-0.8%** | = |  |
| 256x512x512 | 65,536 | 71,218 | 70,990 | 70,550 | 71,116 | 71,116 | 70,379 | — | — | **71,116** | E1 | **92.2%** | **-0.1%** | 70,379 | CSR |
| 256x256x256 | 16,384 | 18,177 | 18,038 | 18,210 | 17,984 | 17,984 | 18,115 | — | — | **17,984** | E1 | **91.1%** | **-1.1%** | = |  |
| 512x256x256 | 32,768 | 37,632 | 37,875 | 38,397 | 38,260 | 38,260 | 38,730 | — | — | **38,260** | E1 | **85.6%** | **+1.7%** | 37,875 | opt2 |
| 512x512x512 | 131,072 | 153,707 | 156,085 | 156,294 | 154,734 | 154,734 | 155,036 | — | — | **154,734** | E1 | **84.7%** | **+0.7%** | = |  |
| 512x512x128 | 32,768 | 38,325 | 37,738 | 36,959 | 38,885 | 38,885 | 39,612 | — | — | **38,885** | E1 | **84.3%** | **+1.5%** | 36,959 | opt3 |
| 512x256x128 | 16,384 | 20,155 | 19,959 | 19,819 | 19,493 | 19,493 | 19,919 | — | — | **19,493** | E1 | **84.1%** | **-3.3%** | = |  |
| 256x128x256 | 8,192 | 10,014 | 10,018 | 9,831 | 9,944 | 9,944 | 9,906 | — | — | **9,944** | E1 | **82.4%** | **-0.7%** | 9,831 | opt3 |
| 512x256x512 | 65,536 | 78,314 | 79,499 | 80,468 | 79,653 | 79,653 | 280,917 | — | — | **79,653** | E1 | **82.3%** | **+1.7%** | 79,499 | opt2 |
| 512x128x256 | 16,384 | 20,307 | 20,812 | 20,575 | 20,538 | 20,538 | 21,065 | — | — | **20,538** | E1 | **79.8%** | **+1.1%** | = |  |
| 128x512x512 | 32,768 | 34,489 | 46,106 | 46,256 | 41,943 | 41,943 | 45,969 | 34,041 | _run_ | **41,943** | E1 | **78.1%** | **+21.6%** | 34,041 | BYP |
| 512x128x512 | 32,768 | 42,767 | 42,500 | 42,554 | 42,743 | 42,743 | 42,578 | — | — | **42,743** | E1 | **76.7%** | **-0.1%** | 42,500 | opt2 |
| 128x256x512 | 16,384 | 18,082 | 25,606 | 25,498 | 21,614 | 21,614 | 27,579 | 17,627 | 17,658 | **21,614** | E1 | **75.8%** | **+19.5%** | 17,627 | BYP |
| 512x128x128 | 8,192 | 11,111 | 12,233 | 11,493 | 11,144 | 11,144 | 11,179 | — | — | **11,144** | E1 | **73.5%** | **+0.3%** | = |  |
| 256x64x256 | 4,096 | 6,050 | 5,907 | 5,804 | 5,860 | 5,860 | 5,701 | — | — | **5,860** | E1 | **69.9%** | **-3.1%** | 5,701 | CSR |
| 512x64x256 | 8,192 | 12,183 | 11,756 | 11,898 | 11,930 | 11,930 | 11,712 | — | — | **11,930** | E1 | **68.7%** | **-2.1%** | 11,712 | CSR |
| 512x64x512 | 16,384 | 24,616 | 24,399 | 24,300 | 24,607 | 24,607 | 24,480 | — | — | **24,607** | E1 | **66.6%** | **-0.0%** | 24,300 | opt3 |
| 256x32x512 | 4,096 | 6,752 | 6,563 | 6,584 | 6,598 | 6,598 | 6,826 | — | — | **6,598** | E1 | **62.1%** | **-2.3%** | 6,563 | opt2 |
| 256x32x256 | 2,048 | 4,081 | _inc_ | 3,859 | 3,771 | 3,771 | 3,667 | — | — | **3,771** | E1 | **54.3%** | **-7.6%** | 3,667 | CSR |
| 512x32x512 | 8,192 | 16,238 | 15,037 | 15,213 | 15,088 | 15,088 | 15,471 | — | — | **15,088** | E1 | **54.3%** | **-7.1%** | 15,037 | opt2 |
| 128x1024x512 | 65,536 | 67,693 | 75,614 | 139,129 | 130,792 | 130,792 | 219,562 | _run_ | — | **130,792** | E1 | **50.1%** | **+93.2%** | 75,614 | opt2 |
| 128x128x512 | 8,192 | 9,792 | 13,138 | 165,585 | 16,995 | 16,995 | — | 9,401 | — | **16,995** | E1 | **48.2%** | **+73.6%** | 9,401 | BYP |
...
- **17 shapes are slower now than their best-ever arm.** Largest gaps: `128x128x512` 1.81× (E1 16,995 vs BYP 9,401), `128x1024x512` 1.73× (E1 130,792 vs opt2 75,614), `128x512x512` 1.23× (E1 41,943 vs BYP 34,041), `128x256x512` 1.23× (E1 21,614 vs BYP 17,627).
- Burst bypass (`BYP`), on the `share_b = 1` family: `128x512x512` -18.8% vs current, `128x256x512` -18.4% vs current, `128x128x512` -44.7% vs current.
