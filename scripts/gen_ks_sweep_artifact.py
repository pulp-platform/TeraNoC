...
A('<div class="card"><h2>512 of 1024 cores never execute &mdash; and it precedes the hang</h2>'
  ...
  'builds.</p></div>'
  '<div class="note bad"><span class="lab">the cores are assigned work and never start</span>'
  ...
  '<div class="note"><span class="lab">why this likely explains the wedge</span>'
