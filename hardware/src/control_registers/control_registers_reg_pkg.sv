...
package control_registers_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    control_registers_reg2hw_eoc_reg_t eoc; // [2603:2572]
    control_registers_reg2hw_wake_up_reg_t wake_up; // [2571:2539]
    control_registers_reg2hw_wake_up_tile_mreg_t [63:0] wake_up_tile; // [2538:427]
  ...
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_WAKE_UP_STRD_OFFSET = 9'h 10c;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_WAKE_UP_OFFST_OFFSET = 9'h 110;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_TCDM_START_ADDRESS_OFFSET = 9'h 114;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_TCDM_END_ADDRESS_OFFSET = 9'h 118;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_NR_CORES_REG_OFFSET = 9'h 11c;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_ENABLE_OFFSET = 9'h 120;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_FLUSH_OFFSET = 9'h 124;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_START_0_OFFSET = 9'h 128;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_START_1_OFFSET = 9'h 12c;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_START_2_OFFSET = 9'h 130;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_START_3_OFFSET = 9'h 134;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_END_0_OFFSET = 9'h 138;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_END_1_OFFSET = 9'h 13c;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_END_2_OFFSET = 9'h 140;
  parameter logic [BlockAw-1:0] CONTROL_REGISTERS_RO_CACHE_END_3_OFFSET = 9'h 144;
  ...
  parameter logic [3:0] CONTROL_REGISTERS_PERMIT [82] = '{
    ...
    4'b 1111, // index[67] CONTROL_REGISTERS_WAKE_UP_STRD
    4'b 1111, // index[68] CONTROL_REGISTERS_WAKE_UP_OFFST
    4'b 1111, // index[69] CONTROL_REGISTERS_TCDM_START_ADDRESS
    4'b 1111, // index[70] CONTROL_REGISTERS_TCDM_END_ADDRESS
    4'b 1111, // index[71] CONTROL_REGISTERS_NR_CORES_REG
    4'b 1111, // index[72] CONTROL_REGISTERS_RO_CACHE_ENABLE
    4'b 1111, // index[73] CONTROL_REGISTERS_RO_CACHE_FLUSH
    4'b 1111, // index[74] CONTROL_REGISTERS_RO_CACHE_START_0
    4'b 1111, // index[75] CONTROL_REGISTERS_RO_CACHE_START_1
    4'b 1111, // index[76] CONTROL_REGISTERS_RO_CACHE_START_2
    4'b 1111, // index[77] CONTROL_REGISTERS_RO_CACHE_START_3
    4'b 1111, // index[78] CONTROL_REGISTERS_RO_CACHE_END_0
    4'b 1111, // index[79] CONTROL_REGISTERS_RO_CACHE_END_1
    4'b 1111, // index[80] CONTROL_REGISTERS_RO_CACHE_END_2
    4'b 1111  // index[81] CONTROL_REGISTERS_RO_CACHE_END_3
  };
