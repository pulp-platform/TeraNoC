...
#define CONTROL_REGISTERS_WAKE_UP_STRD_REG_OFFSET 0x10c

// Wake Up Offst Register
#define CONTROL_REGISTERS_WAKE_UP_OFFST_REG_OFFSET 0x110

// TCDM Start Address Register
#define CONTROL_REGISTERS_TCDM_START_ADDRESS_REG_OFFSET 0x114

// TCDM End Address Register
#define CONTROL_REGISTERS_TCDM_END_ADDRESS_REG_OFFSET 0x118

// Number of Cores Register
#define CONTROL_REGISTERS_NR_CORES_REG_REG_OFFSET 0x11c

// Read-only cache Enable
#define CONTROL_REGISTERS_RO_CACHE_ENABLE_REG_OFFSET 0x120

// Read-only cache Flush
#define CONTROL_REGISTERS_RO_CACHE_FLUSH_REG_OFFSET 0x124
...
#define CONTROL_REGISTERS_RO_CACHE_START_0_REG_OFFSET 0x128

// Read-only cache Region Start
#define CONTROL_REGISTERS_RO_CACHE_START_1_REG_OFFSET 0x12c

// Read-only cache Region Start
#define CONTROL_REGISTERS_RO_CACHE_START_2_REG_OFFSET 0x130

// Read-only cache Region Start
#define CONTROL_REGISTERS_RO_CACHE_START_3_REG_OFFSET 0x134
...
#define CONTROL_REGISTERS_RO_CACHE_END_0_REG_OFFSET 0x138

// Read-only cache Region End
#define CONTROL_REGISTERS_RO_CACHE_END_1_REG_OFFSET 0x13c

// Read-only cache Region End
#define CONTROL_REGISTERS_RO_CACHE_END_2_REG_OFFSET 0x140

// Read-only cache Region End
#define CONTROL_REGISTERS_RO_CACHE_END_3_REG_OFFSET 0x144
